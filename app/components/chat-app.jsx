...
import { LogOut, Search, Plus, Users, MessageCircle, Sun, Moon, UserCircle } from "lucide-react" // Added Sun, Moon, UserCircle
import ChatRoom from "./chat-room"
import CreateChatModal from "./create-chat-modal"
import UserProfileModal from "./user-profile-modal" // Import UserProfileModal
...
export default function ChatApp() {
  ...
  const handleUserSelect = (selectedUser) => {
    ...
    // Ensure user.mobile is available before calling generatePrivateChatId
    ...
    console.log("Generated Chat ID:", newChatId) // Log the generated ID for debugging
    ...
    if (existingChat) {
      ...
      const newChat = {
        id: newChatId, // Use the consistent ID
      ...
      addChat(newChat) // Add the new chat to the global state
      setActiveChat(newChat)
    }
    setShowUserList(false) // Hide user list after selecting
  }
                ...
                <div className="px-2 py-2">
                  {usersLoading ? (
                    ...
                    filteredUsers.map((userItem) => (
                      <Card
                        key={userItem.mobile}
                        className="mb-2 cursor-pointer transition-colors hover:bg-gray-50 dark:hover:bg-gray-700 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700"
                        ...
                        <CardContent className="p-3">
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <h4 className="font-medium truncate">{userItem.name}</h4>
                              <p className="text-sm text-gray-500 dark:text-gray-400 truncate">{userItem.mobile}</p>
                            </div>
                ...
                <div className="px-2 py-2">
                  ...
                  {filteredChats.length === 0 && (
                    <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                      ...
                      >
                        Browse users to start chatting
                      </Button>
                    </div>
                  )}
                </div>
        ...
        {activeChat ? (
          ...
          <div className="flex-1 flex items-center justify-center bg-gray-50 dark:bg-gray-900">
            <div className="text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-4">Select a user or chat to start messaging</p>
